...
public class Instance2 {
  ...
  public static Double[] create(QueryPojo queryPojo, int slowQueryThreshold, boolean isPredictionTime) throws IOException {
    ...
    try {
      QuerySamplingDetails2 querySamplingDetails = mapper.readValue(queryPojo.getParams(), QuerySamplingDetails2.class);
      QuerySamplingDetails2.Details details = querySamplingDetails.getDetails();
